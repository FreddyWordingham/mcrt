...
use crate::input::Universe;
use crate::output::{Data, Sample};
use crate::parts::{Attributes, Key, Local, Photon};
use crate::run::Event;
use arctk::{geom::Trace, math::sample_henyey_greenstein, phys::Crossing};
use physical_constants::SPEED_OF_LIGHT_IN_VACUUM;
use rand::{rngs::ThreadRng, Rng};
use std::f64::consts::PI;

// fn peel_weight(uni: &Universe<Key>, phot: &Photon, dist: f64) -> f64;
